...
public class MetricsService {
    ...
    public EntityTimeline getEntityTimeline(String userId, String entityId) {
        ...
        return new EntityTimeline(
                entityId,
                refs.isEmpty() ? null : refs.get(0).getEntityType(),
    ...
    public DashboardMetrics getDashboard(String userId) {
        ...
        Map<String, List<NoteReference>> byType = all.stream()
                .collect(Collectors.groupingBy(NoteReference::getEntityType));
        ...
        return new DashboardMetrics(
                uniquePeople, uniqueProjects, uniqueHabits, all.size(),
    ...
    private List<TopEntity> topEntities(List<NoteReference> refs, int limit) {
        ...
        Map<String, String> types  = refs.stream().collect(Collectors.toMap(NoteReference::getEntityId, NoteReference::getEntityType, (a, b) -> a));
        LocalDate today = LocalDate.now();
